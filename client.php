...
<?php
	if ($_SESSION["username"]!="admin") {                             //for agent, clients whom agent is resposnible
	$sql = "SELECT client_id,name,birth_date,nid,phone,address,agent_id,policy_id FROM client WHERE agent_id='$username'";
...
}else{                                                                    //for admin, list of all lients 
	$sql = "SELECT client_id,name,birth_date,nid,phone,address,agent_id,policy_id FROM client";
	$result = $conn->query($sql);
