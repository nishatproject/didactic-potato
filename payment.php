                ...
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <form action="" method="GET">
                        <select name="sort_number" class="form-control">
                            <option value="">Select Option</option>
                            
                            <option value="RECIPT NO" <?php if(isset ($_GET['sort_number']) && $_GET['sort_number'] =="RECIPT NO") {echo "selected";} ?>>RECIPT NO</option>
                            <option value="CLIENT ID" <?php if(isset ($_GET['sort_number']) && $_GET['sort_number'] =="CLIENT ID") {echo "selected";} ?>>CLIENT ID</option>
                        </select>
